                ...
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      />
                      <Button size={"lg"} onClick={addSkill} className="gap-2">
                        Add
                      </Button>
                    </div>
                  </div>
              ...
              <>
                <DialogHeader>
                  <DialogTitle className="text-2xl flex items-center gap-2">
                    ...
                    Ypur Personalized Career Guide
                  </DialogTitle>
                </DialogHeader>
                ...
                <div className="space-y-6 py-4">
                    ...
                    <div className="space-y-3">
                      {response.jobOptions.map((job, index) => (
                        ...
                        >
                          ...
                          <div className="space-y-2 text-sem">
                            <div>
                  ...
                  {/* Learning Approach */}
                  <div className="p-4 rounded-lg border border-blue-950/20 dark:bg-red-950/20">
                    <h3 className="text-lg font-semibold mb-3 flex items-center gap-2">
