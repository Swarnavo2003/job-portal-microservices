        ...
        {isYourAccount && (
          <div className="flex gap-3 flex-col sm:flex-row px-4">
            <div className="relative flex-1">
              <Sparkle
                size={18}
                className="absolute left-3 rop-1/2 translate-y-2/3 opacity-50"
              />
              <Input
                type="text"
          ...
          {user.skills && user.skills.length > 0 ? (
                ...
                >
                  ...
                  {isYourAccount && (
                    <button
                      ...
                      className="h-6 w-6 rounded-full bg-red-500 text-white flex items-center justify-center transition-all hover:bg-red-600 hover:scale-110"
                    >
                      <X size={14} />
                    </button>
                  )}
            ...
            <div className="text-center py-12">
              ...
              <CardDescription className="text-base">
                {isYourAccount
                  ? "No Skills Added Yet. Start Buidling Your Profile!"
                  : "No Skills Added"}
              </CardDescription>
            </div>
          )}
