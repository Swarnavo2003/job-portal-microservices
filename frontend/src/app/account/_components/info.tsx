...
export const Info: React.FC<AccountProps> = ({ user, isYourAccount }) => {
        ...
        <div className="h-32 bg-blue-500 relative">
          <div className="absolute -bottom-16 left-8">
            <div className="relative group">
                ...
                <img
                  src={
                    user.profile_picture
                      ? user.profile_picture
                      : `https://avatar.iran.liara.run/boy`
                  }
                  alt=""
              ...
              {/* Edit button for your profile pic */}
              {isYourAccount && (
                <>
                  <Button
                    variant={"secondary"}
            ...
            <div className="mt-8">
              ...
              <div className="flex items-center gap-3 p-4 rounded-lg border hover:border-blue-500 transition-colors">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Resume Documents</p>
                  <Link
                    href={user.resume}
